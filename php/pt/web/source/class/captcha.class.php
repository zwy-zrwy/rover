...
class captcha
{
    ...
    var $themes_jpg = array(
        1 => array('captcha_bg.jpg', 255, 0, 0), //红色
        2 => array('captcha_bg.jpg', 34, 193, 34), //森林绿
        3 => array('captcha_bg.jpg', 128, 42, 42), //棕色
        4 => array('captcha_bg.jpg', 160, 32, 240), //紫色
        5 => array('captcha_bg.jpg', 255, 97, 0), //橙色
    );

    var $themes_gif = array(
        1 => array('captcha_bg.gif', 255, 0, 0),
        2 => array('captcha_bg.gif', 34, 193, 34),
        3 => array('captcha_bg.gif', 128, 42, 42),
        4 => array('captcha_bg.gif', 160, 32, 240),
        5 => array('captcha_bg.gif', 255, 97, 0),
    );
     ...
     * @return void
     */
    function __construct($folder = '', $width = 90, $height = 26)
    {
     ...
     * @return  bool
     */
    function captcha($folder = '', $width = 90, $height = 26)
    {
        if (!empty($folder))
        {
            $this->folder = $folder;

<?php /*a:1:{s:77:"/www/wwwroot/shop.zhouweiyaocloud.xyz/application/index/view/index/index.html";i:1585114423;}*/ ?>
    ...
    <div class="no_enough">
        <ul>
            ...
            <li class="opacity_img1">
                <a href="#" target="_blank">
                    <div class="p_img">
                        <a href="<?php echo url('goods/index',['id'=>$goods['id']]); ?>"><img src="<?php echo htmlentities($goods['pic']); ?>" /></a>
                    </div>

<?php /*a:2:{s:57:"D:\SVN\zhouweiyao\application\admin\view\admin\index.html";i:1573471329;s:52:"D:\SVN\zhouweiyao\application\admin\view\layout.html";i:1576717639;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 15px;"><a href="<?php echo url('admin/admin/add'); ?>" class="layui-btn layui-btn-sm layui-btn-warm"><i class="layui-icon">&#xe654;</i>添加</a>
<table class="layui-table">
    <thead>
    <tr><th>ID</th><th>名称</th><th>角色名</th><th>状态</th><th>操作</th></tr></thead>
    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tbody><tr>
        <td><?php echo htmlentities($vo['id']); ?></td><td><?php echo htmlentities($vo['username']); ?></td><td><?php echo htmlentities($vo['rname']); ?></td><td><?php if($vo['status'] == 1): ?>启用<?php else: ?>禁用<?php endif; ?></td>
        <td width="200px" >

            <a href="<?php echo url('admin/admin/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-sm  layui-btn-normal"><i class="layui-icon">&#xe6b2;</i>编辑</a>
            <?php if($vo['id'] != 1): ?>
                <a href="<?php echo url('admin/admin/del',['id'=>$vo['id']]); ?>" class="layui-btn  layui-btn-sm layui-btn-danger"><i class="layui-icon">&#xe640;</i>删除</a>
            <?php endif; ?>
        </td>
    </tr></tbody>
    <?php endforeach; endif; else: echo "" ;endif; ?>

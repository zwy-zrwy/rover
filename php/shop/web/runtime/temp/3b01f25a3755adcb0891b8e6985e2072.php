<?php /*a:2:{s:57:"D:\shop\zhouweiyao\application\admin\view\goods\edit.html";i:1573994501;s:53:"D:\shop\zhouweiyao\application\admin\view\layout.html";i:1576717639;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 15px;"><form action="<?php echo url('admin/goods/edit'); ?>" method="post" class="layui-form" enctype="multipart/form-data">
    <div class="layui-form-item">
        <label class="layui-form-label">商品名</label>
        <div class="layui-input-block">
            <input type="text" name="name" required  lay-verify="required" placeholder="请输入商品名" autocomplete="off" class="layui-input" value="<?php echo htmlentities($info['name']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">预览图</label>
        <div class="layui-input-block"><img src="/uploads/<?php echo htmlentities($info['pic']); ?>" alt="" height="60px" width="70px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <img src="/uploads/<?php echo htmlentities($vo['pic']); ?>" alt="" height="60px" width="70px">
            <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="content" placeholder="请输入商品简介" class="layui-textarea"><?php echo htmlentities($info['content']); ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="brand_id" lay-verify="required">
                ...
                <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($info['brand_id'] == $vo['id']): ?> selected<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="price" required  lay-verify="required" placeholder="请输入商品价格" autocomplete="off" class="layui-input" value="<?php echo htmlentities($info['price']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">库存</label>
        <div class="layui-input-block">
            <input type="text" name="number" required  lay-verify="required" placeholder="请输入商品库存" autocomplete="off" class="layui-input" value="<?php echo htmlentities($info['number']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="cid" lay-verify="required">
                <?php if(is_array($cat) || $cat instanceof \think\Collection || $cat instanceof \think\Paginator): $i = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo['sub']) || $vo['sub'] instanceof \think\Collection || $vo['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;if(is_array($sub['sub']) || $sub['sub'] instanceof \think\Collection || $sub['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $sub['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo htmlentities($cat['id']); ?>" <?php if($cat['id'] == $info['cid']): ?>selected<?php endif; ?> ><?php echo htmlentities($cat['name']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="is_attr" value="1" title="启用" <?php if($info['is_attr'] == 1): ?>checked<?php endif; ?>>
            <input type="radio" name="is_attr" value="0" title="禁用" <?php if($info['is_attr'] == 0): ?>checked<?php endif; ?>>
            <table class="layui-table">
                ...
                <tr>
                    <td><?php echo htmlentities($vo['name']); ?></td><td><input class="layui-input" type="text" name="prices[<?php echo htmlentities($vo['id']); ?>]" value="<?php echo htmlentities($vo['price']); ?>"></td><td><input  class="layui-input" type="text" name="nums[<?php echo htmlentities($vo['id']); ?>]"  value="<?php echo htmlentities($vo['num']); ?>"></td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
            </table>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="status" value="0" title="禁用" <?php if($info['status'] != 1): ?>checked<?php endif; ?>>
        </div>
    </div>

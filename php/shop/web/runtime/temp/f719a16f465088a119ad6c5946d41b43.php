<?php /*a:2:{s:58:"D:\shop\zhouweiyao\application\admin\view\brand\index.html";i:1573636782;s:53:"D:\shop\zhouweiyao\application\admin\view\layout.html";i:1576717639;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 15px;"><a href="<?php echo url('admin/brand/add'); ?>" class="layui-btn layui-btn-sm layui-btn-warm"><i class="layui-icon">&#xe654;</i>添加</a>
<table class="layui-table">
    <thead>
    <tr><th>ID</th><th>图片</th><th>品牌名</th><th>状态</th><th>操作</th></tr></thead>
    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tbody><tr>
        <td><?php echo htmlentities($vo['id']); ?></td><td><img src="<?php echo htmlentities($vo['pic']); ?>" alt=""></td><td><?php echo htmlentities($vo['name']); ?></td><td><?php if($vo['status'] == 1): ?>启用<?php else: ?>禁用<?php endif; ?></td>
        <td width="200px" >
            <a href="<?php echo url('admin/brand/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-sm  layui-btn-normal"><i class="layui-icon">&#xe6b2;</i>编辑</a>
            <a href="<?php echo url('admin/brand/del',['id'=>$vo['id']]); ?>" class="layui-btn  layui-btn-sm layui-btn-danger"><i class="layui-icon">&#xe640;</i>删除</a>
        </td>
    </tr></tbody>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</table></div>
